...
'<your-gcp-project-id>.<your_dataplex_zone_id>.asset_bucket' AS table_id,
'value' AS column_id,
...
to_json(struct(data.contact_type,data.row_id,data.ts,data.value)) AS include_reference_columns_json_string,
FROM
zero_record
LEFT JOIN
data
