...
DATAPLEX_ZONE_ID="${DATAPLEX_ZONE_ID:-}"
DATAPLEX_BIGQUERY_DATASET_ID="${DATAPLEX_BIGQUERY_DATASET_ID:-}"
DATAPLEX_BUCKET_NAME="${DATAPLEX_BUCKET_NAME:-}"
...
_DATAPLEX_ZONE_ID="${DATAPLEX_ZONE_ID}",\
_DATAPLEX_BIGQUERY_DATASET_ID="${DATAPLEX_BIGQUERY_DATASET_ID}",\
_DATAPLEX_BUCKET_NAME="${DATAPLEX_BUCKET_NAME}",\
